...
type BillingMeUsageChargesSummaryListData = {
    /**
     * @min 0
     * @max 9007199254740991
     */
...
type BillingMeUsageChargesSummaryListError = {
    message: string;
};
interface BillingMeUsageChargesSummaryListParams {
    /** @pattern ^\d{4}-\d{2}-\d{2}$ */
    fromDate: string;
    /** @minLength 1 */
    operation?: string;
...
interface ProjectsProgressBoardDuplicateCheckCreateData {
    /**
     * @min 0
     * @max 9007199254740991
     */
    ...
    matches: {
        ...
        reasons: ("company_high_match" | "company_near_match" | "title_high_match" | "title_near_match" | "same_company_and_title_shape" | "description_near_duplicate" | "description_contained" | "description_shingle_overlap")[];
        /**
         * @min 0
         * @max 1
         */
...
type ProjectsProgressBoardDuplicateCheckCreateError = {
    message: string;
};
interface ProjectsProgressBoardDuplicateCheckCreateParams {
    /** @minLength 1 */
    projectId: string;
}
interface ProjectsProgressBoardDuplicateCheckCreatePayload {
    /**
     * @minLength 1
     * @maxLength 180
     */
...
declare namespace PublicApi {
  ...
  */
    namespace BillingMeUsageChargesSummaryList {
        type RequestParams = {};
        type RequestQuery = {
            /** @pattern ^\d{4}-\d{2}-\d{2}$ */
            fromDate: string;
        ...
        type RequestBody = never;
        type RequestHeaders = {};
        type ResponseBody = BillingMeUsageChargesSummaryListData;
    }
    /**
   * No description
   * @tags Authentication
  ...
  */
    namespace ProjectsProgressBoardDuplicateCheckCreate {
        type RequestParams = {
            /** @minLength 1 */
            projectId: string;
        };
        type RequestQuery = {};
        type RequestBody = ProjectsProgressBoardDuplicateCheckCreatePayload;
        type RequestHeaders = {};
        type ResponseBody = ProjectsProgressBoardDuplicateCheckCreateData;
    }
    /**
   * No description
   * @tags Progress Board
...
declare class PublicApi<SecurityDataType extends unknown> {
     ...
     */
        billingMeUsageChargesSummaryList: (query: BillingMeUsageChargesSummaryListParams, params?: RequestParams) => Promise<AxiosResponse<BillingMeUsageChargesSummaryListData, any, {}>>;
        /**
     * No description
     *
     * @tags Authentication
     ...
     */
        projectsProgressBoardDuplicateCheckCreate: ({ projectId }: ProjectsProgressBoardDuplicateCheckCreateParams, data: ProjectsProgressBoardDuplicateCheckCreatePayload, params?: RequestParams) => Promise<AxiosResponse<ProjectsProgressBoardDuplicateCheckCreateData, any, {}>>;
        /**
     * No description
     *
     * @tags Progress Board
...
declare function createCareerboardClientInstance(configOrApiKey: CareerboardClientConfig | string): {
    ...
    readonly billing: {
        ...
        readonly getUsageChargesSummary: MethodWrapper<(query: BillingMeUsageChargesSummaryListParams, params?: RequestParams) => Promise<axios.AxiosResponse<BillingMeUsageChargesSummaryListData, any, {}>>>;
    ...
    readonly projects: {
        ...
        readonly checkProgressBoardDuplicate: MethodWrapper<({ projectId }: ProjectsProgressBoardDuplicateCheckCreateParams, data: ProjectsProgressBoardDuplicateCheckCreatePayload, params?: RequestParams) => Promise<axios.AxiosResponse<ProjectsProgressBoardDuplicateCheckCreateData, any, {}>>>;
